...
export const researchProjectTemplate: ProjectTemplateDefinition = {
  ...
  nodes: [
    { title: '申请人资质', children: ['个人资质', '团队成员资质'] },
    { title: '前期研究基础', children: ['代表性论文', '知识产权'] },
    { title: '在研与完成项目', children: ['主持项目', '参与项目'] },
    { title: '条件与平台', children: ['实验条件', '协作单位'] },
    { title: '其他附件', children: ['证明文件', '其他材料'] },
  ],
}
